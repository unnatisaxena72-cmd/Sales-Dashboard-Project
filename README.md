...
[`dataset/Sample-Superstore.csv`](./dataset/Sample-Superstore.csv) — Sample Superstore retail dataset containing order-level details: Region, Category, Sub-Category, Sales, Quantity, Discount, Profit, Customer Segment, and Shipping Mode.
